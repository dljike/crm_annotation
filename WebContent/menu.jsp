									...
									<TD>
										<TABLE id=table_1 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center border=0>
											<TBODY>
												...
												<TR> 
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/customer/findPageList.action" target=main>－ 客户列表</A>
													</TD>
												</TR>
											</TBODY>
										</TABLE>
									...
									<TD>
										<TABLE id=table_2 style="DISPLAY: none" cellSpacing=0
											...
											<TBODY>
												...
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/linkman/findLinkManList" target=main>－联系人列表</A>
													</TD>
												</TR>
									...
									<TD>
										<TABLE id=table_5 style="DISPLAY: none" cellSpacing=0 cellPadding=2 width=155 align=center border=0>
											<TBODY>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/welcome.htm" target=main>－新增客户拜访</A></TD>
												</TR>
												<TR>
													<TD class=menuSmall>
														<A class=style2 href="${pageContext.request.contextPath}/welcome.htm" target=main>－客户拜访列表</A>
													</TD>
												</TR>
											</TBODY>
										</TABLE>
